...
target_genes_Y<- c("Manes.04G064300","Manes.05G047400","Manes.09G021000")
target_genes_A<- c("g10703.t1","g2329.t1","g3510.t1","g9749.t1","g5395.t1","g5311.t1","g65.t1","g9174.t1","g2610.t1","g10723.t1","g1004.t1","g4807.t1","g3508.t1","g5979.t1","g4193.t1")

NORM_EXP_TOPAMF<-t(DGE_AMF_N$E[rownames(DGE_AMF_N$E) %in% target_genes_A ,])
# cassava genes
NORM_EXP_TOPYUCA<-t(DGE_YUCA_N$E[rownames(DGE_YUCA_N$E) %in%  target_genes_Y  ,])
...
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_cytoskelette_F2.pdf',width=15,height=15,useDingbats = FALSE)
...
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]

cor2plot_pos_q90<-list();cor2plot_neg<-NULL;cor2plot_pos<-NULL;cor2plot_pos_q90_vf<-NULL
for (i in 1:dim(cor2plot)[2]) {
  cor2plot_neg<-cor2plot[(cor2plot[,i]<quantile(cor2plot[,i],.05)&
                            cor2plot[,i]< (-0.7) )| 
                           (cor2plot[,i]>quantile(cor2plot[,i],.95)&
                              cor2plot[,i]> (0.7) ),]
  cor2plot_pos_q90[[i]]<-rbind.data.frame(cor2plot_neg,cor2plot_pos)
  cor2plot_pos_q90_vf<-rbind.data.frame(cor2plot_pos_q90_vf,cor2plot_pos_q90[[i]])
}
pheatmap(t(cor2plot_pos_q90_vf) ,cellwidth = 8,cellheight = 8,labels_col = paste (colnames(t(cor2plot_pos_q90_vf)),target_function$Function[order(match(target_function$gene,colnames(t(cor2plot_pos_q90_vf))))],sep="___"),
         labels_row = paste (colnames(cor2plot_pos_q90_vf),target_function2$Function[order(match(target_function2$gene,colnames(cor2plot_pos_q90_vf)))],sep="___"))


pheatmap(t(cor2plot) ,cellwidth = 8,cellheight = 8)

pheatmap(t(cor2plot) ,cellwidth = 8,cellheight = 8,labels_col = paste (colnames(t(cor2plot)),target_function$Function[order(match(target_function$gene,colnames(t(cor2plot))))],sep="___"),
         labels_row = paste (colnames(cor2plot),target_function2$Function[order(match(target_function2$gene,colnames(cor2plot)))],sep="___"))
dev.off()
...
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_secretory_amf.pdf',width=35,height=15,useDingbats = FALSE)
...
write.table(  cor2plot,
              '~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_secretory_plant.txt',
...
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_secretory_plant.pdf',width=25,height=15,useDingbats = FALSE)

  cor2plot_pos_q90<-list();cor2plot_neg<-list();cor2plot_pos<-NULL;cor2plot_pos_q90_vf<-NULL
  for (i in 1:dim(cor2plot)[2]) {
  cor2plot_neg[[i]]<-cor2plot[(cor2plot[,i]<quantile(cor2plot[,i],.025)&
                        cor2plot[,i]< (-0.7) )| 
                          (cor2plot[,i]>quantile(cor2plot[,i],.975)&
                             cor2plot[,i]> (0.7) ),]}
  pheatmap(
  cbind.data.frame(
  t(cor2plot_neg[[1]]),
  t(cor2plot_neg[[2]]),t(cor2plot_neg[[3]]),t(cor2plot_neg[[4]]),
  t(cor2plot_neg[[5]]),t(cor2plot_neg[[6]]),t(cor2plot_neg[[7]]),
  t(cor2plot_neg[[8]]),t(cor2plot_neg[[9]]),t(cor2plot_neg[[10]]))
  ,cellwidth = 8,cellheight = 8)
  
  dev.off()
  pheatmap(t(cor2plot_pos_q90_vf) ,cellwidth = 8,cellheight = 8)
  
  pheatmap(t(cor2plot_neg[[i]]),cellwidth = 8,cellheight = 8)
pheatmap(t(cor2plot) ,cellwidth = 8,cellheight = 8,labels_col = paste (colnames(t(cor2plot)),target_function$Function[order(match(target_function$gene,colnames(t(cor2plot))))],sep="___"),
         labels_row = paste (colnames(cor2plot),target_function2$Function[order(match(target_function2$gene,colnames(cor2plot)))],sep="___"))
dev.off()
...
target_function2<-target_function2[!duplicated(target_function2$gene),]
cor2plot<-t(cor2plot)
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_secretory_amf.pdf',width=25,height=15,useDingbats = FALSE)

cor2plot_pos_q90<-list();cor2plot_neg<-list();cor2plot_pos<-NULL;cor2plot_pos_q90_vf<-NULL
for (i in 1:dim(cor2plot)[2]) {
  cor2plot_neg[[i]]<-cor2plot[(cor2plot[,i]<quantile(cor2plot[,i],.005)&
                                 cor2plot[,i]< (-0.8) )| 
                                (cor2plot[,i]>quantile(cor2plot[,i],.995)&
                                   cor2plot[,i]> (0.8) ),]}
pheatmap(
  cbind.data.frame(
    t(cor2plot_neg[[1]]),
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_signalling_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
pheatmap(t(cor2plot) ,cellwidth = 8,cellheight = 8,labels_col = paste (colnames(t(cor2plot)),target_function$Function[order(match(target_function$gene,colnames(t(cor2plot))))],sep="___") )
dev.off()
...
cor2plot<-cor2plot[,!colnames(cor2plot) %in% target_genes]
                   ...
                   cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_signalling_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
pheatmap(cor2plot ,cellwidth = 8,cellheight = 8,labels_col = paste (colnames(cor2plot),target_function$Function[order(match(target_function$gene,colnames(cor2plot)))],sep="___") )
dev.off()
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_abctransp_plant.pdf',width=25,height=15,useDingbats = FALSE)
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_abctransp_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_protsynthesis_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_protsynthesis_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_protpostrasnmod_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_protpostrasnmod_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_protdegradation_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_protdegradation_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_lipidmetabo_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_lipidmetabo_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_hormonemetabo_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_hormonemetabo_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_cellorganisation_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_cellorganisation_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_cellvesitransport_plant.pdf',width=25,height=15,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/AMF_cellvesitransport_amf.pdf',width=35,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% target_genes ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_glycolysis_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_glycolysis_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_lipidmetabo_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_lipidmetabo_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_MajorCHOmetabo_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_MajorCHOmetabo_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Protdegradation_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Protdegradation_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Protfoldsyntmod_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Protfoldsyntmod_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Secretory_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Secretory_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Calvin_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Calvin_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Signalling_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_Signalling_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_transport_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_transport_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[grep("Manes",colnames(cor2plot)),]
cor2plot<-cor2plot[,grep(".t1",colnames(cor2plot))]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_RNAregulation_amf.pdf',width=32,height=15,useDingbats = FALSE)
target_function<-Mercator_Rirregularis[Mercator_Rirregularis$gene %in% amf ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
...
cor2plot<-cor2plot[colnames(cor2plot) %in% target_genes,]
cor2plot<-cor2plot[,grep("\\.1",colnames(cor2plot),invert=T)]
pdf('~/Google Drive/Doctorat_shared_unil/RNA-seq/Results/MANUSCRIPT_NATURE_v1/V5/gene_gene_interaction_func/Cassava_RNAregulation_cassava.pdf',width=10,height=10,useDingbats = FALSE)
target_function<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function<-target_function[!duplicated(target_function$gene),]
target_function2<-Mercator_Mesculenta[Mercator_Mesculenta$gene %in% cas ,]
target_function2<-target_function2[!duplicated(target_function2$gene),]
