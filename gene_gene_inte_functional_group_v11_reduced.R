...
sample(length(rownames(cor2plot)),40,replace = F)

pheatmap(t(cor2plot[sample(length(rownames(cor2plot)),50,replace = F),]),cellwidth = 8,cellheight = 8)

sample(80,length(rownames(cor2plot)),replace = T)
pheatmap(t(cor2plot))
...
cor2plot[duplicated(rownames(cor2plot)),]
...
sample(length(colnames(cor2plot)),48,replace = F)
pheatmap(cor2plot[,sample(length(colnames(cor2plot)),48,replace = F)],cellwidth = 8,cellheight = 8)

sample50<-cbind.data.frame(cor2plot[,sample(length(colnames(cor2plot)),48,replace = F)],
cor2plot[, colnames(cor2plot) %in% c("g5801.t1","g9899.t1")])
pheatmap(sample50,cellwidth = 8,cellheight = 8)
